...
Make **Checkpoint: Save** capture the current Git, editor, terminal, resource, and important-file state immediately without prompting. Preserve previously known semantic context through the existing merge behavior.
